...
import com.example.cake4u.Adapters.CakesAdapter;
...
public class Admin_edit_cakes extends AppCompatActivity {
    ...
    private CakesAdapter itemsAdapter;
    private ArrayList<Cakes> admin_items;

    private Bitmap bp=null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_edit_cakes);
        ...
        admin_product_back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Admin_edit_cakes.this,AdminHomeActivity.class);
    ...
    private void delete_admin_product(){
        ...
        builder.setTitle("Add new Products").setMessage("Are you sure want to delete this Item?").setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(isDeleted){
                    Toast.makeText(Admin_edit_cakes.this,"Product deleted Sucessfully!!",Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(Admin_edit_cakes.this,AdminHomeActivity.class);
                    startActivity(intent);
                }
                else{
                    Toast.makeText(Admin_edit_cakes.this,"Error Occur Cannot Delete",Toast.LENGTH_SHORT).show();
                }
            }
            ...
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Admin_edit_cakes.this, "Delete Cancel..", Toast.LENGTH_SHORT).show();
            }
    ...
    */
    ...
    private void Update_Admin_product_Details(){
        ...
        getValues();
        if (ExceptionFound) {
            Toast.makeText(Admin_edit_cakes.this, "Please select an Image...", Toast.LENGTH_SHORT).show();
        } else {
            if (admin_product_name.getText().toString().isEmpty()) {
                Toast.makeText(Admin_edit_cakes.this, "Please Enter product Name..", Toast.LENGTH_SHORT).show();
            } else if (admin_product_des.getText().toString().isEmpty()) {
                Toast.makeText(Admin_edit_cakes.this, "Please Enter product description..", Toast.LENGTH_SHORT).show();
            } else if (admin_product_price.getText().toString().isEmpty()) {
                Toast.makeText(Admin_edit_cakes.this, "Please Enter product Price..", Toast.LENGTH_SHORT).show();
            } else if (admin_product_counts.getText().toString().isEmpty()) {
                Toast.makeText(Admin_edit_cakes.this, "Please Enter product Count..", Toast.LENGTH_SHORT).show();
            } else {
                ...
                builder.setTitle("Add New Category Image").setMessage("Are you sure to add new category!").setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (isNameAvailable) {
                            ...
                            if (isAdd) {
                                Toast.makeText(Admin_edit_cakes.this, "Item sucessfully Updated", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(Admin_edit_cakes.this, AdminHomeActivity.class);
                                startActivity(intent);
                            } else {
                                Toast.makeText(Admin_edit_cakes.this, "Error!! Failed to Update...", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        } else {
                            Toast.makeText(Admin_edit_cakes.this, "Sorry Name Already Exists..", Toast.LENGTH_SHORT).show();
                    ...
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Admin_edit_cakes.this, "Update Cancel..", Toast.LENGTH_SHORT).show();
                    }
                }).setCancelable(false).show();
            }
