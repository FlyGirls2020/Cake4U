...
public class SellerAddCakeActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_add_cake);
        ...
        spinner.setOnItemSelectedListener(SellerAddCakeActivity.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(SellerAddCakeActivity.this,AppHomeActivity.class);
...
//        Toast.makeText(this,String.valueOf(i),Toast.LENGTH_SHORT).show();
    ...
    */
    ...
    private void Add_admin_Category_Details() {
        getValues();
        if (ExceptionFound) {
            Toast.makeText(SellerAddCakeActivity.this, "Please select an Image...", Toast.LENGTH_SHORT).show();
        } else {
            if (name.getText().toString().isEmpty()) {
                Toast.makeText(SellerAddCakeActivity.this, "Please Enter Product Name..", Toast.LENGTH_SHORT).show();
            } else if (des.getText().toString().isEmpty()) {
                Toast.makeText(SellerAddCakeActivity.this, "Please give Product Description..", Toast.LENGTH_SHORT).show();
            } else if (price.getText().toString().isEmpty()) {
                Toast.makeText(SellerAddCakeActivity.this, "Please Enter Product Price..", Toast.LENGTH_SHORT).show();
            } else if (count.getText().toString().isEmpty()) {
                Toast.makeText(SellerAddCakeActivity.this, "Please give Product Count..", Toast.LENGTH_SHORT).show();
            } else {
                ...
                if(isAdd){
                    Toast.makeText(SellerAddCakeActivity.this, "sucessfully added..", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(SellerAddCakeActivity.this, "cannot added..", Toast.LENGTH_SHORT).show();
                }
