...
public class Admin_add_cakes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_cakes);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Admin_add_cakes.this, Admin_add_new_category.class);
    ...
    */
    ...
    private void Add_admin_Category_Details(){
        ...
        getValues();
        if(ExceptionFound){
            Toast.makeText(Admin_add_cakes.this,"Please select an Image...",Toast.LENGTH_SHORT).show();
        }
        else {
            if( product_Name.getText().toString().isEmpty()){
                Toast.makeText(Admin_add_cakes.this,"Please Enter Product Name..",Toast.LENGTH_SHORT).show();
            }
            else if(product_desc.getText().toString().isEmpty()){
                Toast.makeText(Admin_add_cakes.this,"Please give Product Description..",Toast.LENGTH_SHORT).show();
            }
            else if(product_pri.getText().toString().isEmpty()){
                Toast.makeText(Admin_add_cakes.this,"Please Enter Product Price..",Toast.LENGTH_SHORT).show();
            }
            else if(product_count.getText().toString().isEmpty()){
                Toast.makeText(Admin_add_cakes.this,"Please give Product Count..",Toast.LENGTH_SHORT).show();
            }
            else {
                ...
                builder.setTitle("Add New Product").setMessage("Are you sure to add new category!").setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(isNameAvailable) {
                            ...
                            if (isAdd) {
                                Toast.makeText(Admin_add_cakes.this, "New Product  Added", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(Admin_add_cakes.this, Admin_add_new_category.class);
                                startActivity(intent);
                            } else {
                                Toast.makeText(Admin_add_cakes.this, "Error!! Failed to Add..", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        }
                        else{
                            Toast.makeText(Admin_add_cakes.this, "Sorry Name Already Exists..", Toast.LENGTH_SHORT).show();
                    ...
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Admin_add_cakes.this, "Update Cancel..", Toast.LENGTH_SHORT).show();
                    }
