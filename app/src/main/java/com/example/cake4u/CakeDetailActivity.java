...
public class CakeDetailActivity extends AppCompatActivity {
    ...
    private void insert_cart_details() {
        ...
        if(isInserted && isAdd){
            Toast.makeText(CakeDetailActivity.this,"sucessfully inserted",Toast.LENGTH_SHORT).show();
            Intent intent=new Intent(CakeDetailActivity.this,AppHomeActivity.class);
            startActivity(intent);

        }
        else{
            Toast.makeText(CakeDetailActivity.this,"Error cannot insert!!",Toast.LENGTH_SHORT).show();
        }
