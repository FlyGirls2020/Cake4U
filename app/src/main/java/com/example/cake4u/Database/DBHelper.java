...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String          DATABASE_NAME="Cake4U.db";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String ADMIN_CATEGORY_DETAILS_ENTRIES="CREATE TABLE "+ CustomerMaster.CakeCategory.TABLE_NAME+"("+
                CustomerMaster.CakeCategory.COLUMN_NAME_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"+
                CustomerMaster.CakeCategory.COLUMN_NAME_IMAGE+" LONGBLOB,"+
                CustomerMaster.CakeCategory.COLIMN_NAME_CATEGORY_NAME+" TEXT)";

        String ADMIN_PRODUCT_DETAILS_ENTRIES="CREATE TABLE "+ CustomerMaster.CakeItems.TABLE_NAME +"("+
                CustomerMaster.CakeItems.COLUMN_NAME_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"+
                CustomerMaster.CakeItems.COLUMN_NAME_PRODUCT_NAME + " TEXT,"+
                CustomerMaster.CakeItems.COLUMN_NAME_COUNT +" INTEGER,"+
                CustomerMaster.CakeItems.COLUMN_NAME_DESCRIPTION +" TEXT,"+
                CustomerMaster.CakeItems.COLUMN_NAME_PRICE + " TEXT,"+
                CustomerMaster.CakeItems.COLUMN_NAME_PRODUCTIMAGE + " LONGBLOB,"+
                CustomerMaster.CakeItems.COLUMN_NAME_CATEGORY_NAME +" TEXT," +
                CustomerMaster.CakeItems.COLUMN_NAME_FOREIGNKEY+" INTEGER,CONSTRAINT fk_pro_cat FOREIGN KEY ("+
                CustomerMaster.CakeItems.COLUMN_NAME_FOREIGNKEY + ") REFERENCES "+ CustomerMaster.CakeItems.TABLE_NAME+"("+
                CustomerMaster.CakeItems.COLUMN_NAME_ID +") ON DELETE CASCADE ON UPDATE CASCADE)";
        ...
        String CUSTOMER_CART_CREATES_ENTRIES="CREATE TABLE "+CustomerMaster.UserCart.TABLE_NAME+"("+
                ...
                " FOREIGN KEY ("+
                CustomerMaster.UserCart.COLUMN_FOREIGN1+") REFERENCES "+ CustomerMaster.CakeItems.TABLE_NAME+"("+
                CustomerMaster.CakeItems.COLUMN_NAME_ID +") ON DELETE CASCADE ON UPDATE CASCADE, "+
                "FOREIGN KEY ("+
...
//                CustomerMaster.SellerProductItems.COLUMN_NAME_PRODUCTIMAGE + " LONGBLOB)";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS "+ CustomerMaster.CakeItems.TABLE_NAME);
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS "+ CustomerMaster.CakeItems.TABLE_NAME);
    ...
    public boolean Seller_insert_product(String prodname,String proddesc,String prodprice,Integer prodcounts){
        SQLiteDatabase db=getWritableDatabase();
        ContentValues values=new ContentValues();
        values.put(CustomerMaster.SellerCakeItems.COLUMN_NAME_PRODUCT_NAME,prodname);
        values.put(CustomerMaster.SellerCakeItems.COLUMN_NAME_DESCRIPTION,proddesc);
        values.put(CustomerMaster.SellerCakeItems.COLUMN_NAME_PRICE,prodprice);
        values.put(CustomerMaster.SellerCakeItems.COLUMN_NAME_COUNT,prodcounts);

        long rowId=db.insert(CustomerMaster.SellerCakeItems.TABLE_NAME,null,values);
        return rowId != -1;
    ...
    public Cursor Seller_view_product(){
        SQLiteDatabase db = getReadableDatabase();
        String sql = "select * from "+CustomerMaster.SellerCakeItems.TABLE_NAME ;
    ...
    public boolean Seller_update_product(String prodname,String proddesc,String prodprice,Integer prodcounts,Integer prodid){
        ...
        values.put(CustomerMaster.SellerCakeItems.COLUMN_NAME_PRICE,prodprice);
        values.put(CustomerMaster.SellerCakeItems.COLUMN_NAME_COUNT,prodcounts);
        values.put(CustomerMaster.SellerCakeItems.COLUMN_NAME_ID,prodid);

        long rowId=db.update(CustomerMaster.SellerCakeItems.TABLE_NAME, values,  CustomerMaster.SellerCaketItems.COLUMN_NAME_ID+"=?",new String[]{String.valueOf(prodid)});
        if(rowId==-1){
            return false;
        }else {
            return  true;
    ...
    public ArrayList Retrive_admin_product_details(){
        ...
        String sql="SELECT * FROM "+ CustomerMaster.CakeItems.TABLE_NAME;
    ...
    public ArrayList Retrive_admin_search_product_details(String pname){
        ...
        String sql="SELECT * FROM "+ CustomerMaster.CakeItems.TABLE_NAME + " WHERE "+ CustomerMaster.CakeItems.COLUMN_NAME_PRODUCT_NAME
                +" LIKE ? OR " +CustomerMaster.CakeItems.COLUMN_NAME_CATEGORY_NAME + " LIKE ?" ;
    ...
    public boolean Admin_delete_category(String id){
        ...
        try{
            SQLiteDatabase db=getReadableDatabase();
            String selection=CustomerMaster.CakeCategory.COLUMN_NAME_ID + " = ?";
            String[] selectionArgs = {id};
            db.delete(CustomerMaster.CakeCategory.TABLE_NAME,selection,selectionArgs);
            return true;
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    public boolean Admin_add_Category_Details(byte[] image,String name){
        SQLiteDatabase db=getWritableDatabase();
        ContentValues values=new ContentValues();
        values.put(CustomerMaster.CakeCategory.COLUMN_NAME_IMAGE,image);
        values.put(CustomerMaster.CakeCategory.COLIMN_NAME_CATEGORY_NAME,name);
        long rowId=db.insert(CustomerMaster.CakeCategory.TABLE_NAME,null,values);
        return rowId != -1;
    ...
    public boolean Admin_add_product_Details(String name,String desc,String price,String count,byte[] image,String fid,String cname){
        SQLiteDatabase db=getWritableDatabase();
        ContentValues values=new ContentValues();
        values.put(CustomerMaster.CakeItems.COLUMN_NAME_PRODUCT_NAME,name);
        values.put(CustomerMaster.CakeItems.COLUMN_NAME_COUNT,count);
        values.put(CustomerMaster.CakeItems.COLUMN_NAME_DESCRIPTION,desc);
        values.put(CustomerMaster.CakeItems.COLUMN_NAME_PRICE,price);
        values.put(CustomerMaster.CakeItems.COLUMN_NAME_PRODUCTIMAGE,image);
        values.put(CustomerMaster.CakeItems.COLUMN_NAME_CATEGORY_NAME,cname);
        values.put(CustomerMaster.CakeItems.COLUMN_NAME_FOREIGNKEY,fid);


        long rowId=db.insert(CustomerMaster.CakeItems.TABLE_NAME,null,values);
    ...
    public boolean Admin_update_category_Info(String id,String name,byte[]image){
        ...
        String selection= CustomerMaster.CakeCategory.COLUMN_NAME_ID +" = ?";
        String[] selectionArgs = {id};
        int count=db.update(CustomerMaster.CakeCategory.TABLE_NAME,values,selection,selectionArgs);

        ContentValues values1 =new ContentValues();
        values1.put(CustomerMaster.CakeItems.COLUMN_NAME_CATEGORY_NAME,name);
        String selection1=CustomerMaster.CakeItems.COLUMN_NAME_FOREIGNKEY + " = ?";
        String[] selectionArgs1 = {id};
        db.update(CustomerMaster.CakeItems.TABLE_NAME,values1,selection1,selectionArgs1);
    ...
    public boolean Admin_update_product_info(String id,String name,String des,String price,byte[]image,String count){
        try {
            ...
            values.put(CustomerMaster.CakeItems.COLUMN_NAME_PRODUCT_NAME, name);
            values.put(CustomerMaster.CakeItems.COLUMN_NAME_COUNT, count);
            values.put(CustomerMaster.CakeItems.COLUMN_NAME_DESCRIPTION, des);
            values.put(CustomerMaster.CakeItems.COLUMN_NAME_PRICE, price);
            values.put(CustomerMaster.CakeItems.COLUMN_NAME_PRODUCTIMAGE, image);
            String selection = CustomerMaster.CakeItems.COLUMN_NAME_ID + " = ?";
            String[] selectionArgs = {id};

            int counts = db.update(CustomerMaster.CakeItems.TABLE_NAME, values, selection, selectionArgs);
            return counts > 0;
        }
    ...
    public Cursor Admin_product_name_check(){
        SQLiteDatabase db=getReadableDatabase();
        String[] projection = {CustomerMaster.CakeCategory.COLUMN_NAME_ID, CustomerMaster.CakeCategory.COLUMN_NAME_IMAGE, CustomerMaster.CakeCategory.COLIMN_NAME_CATEGORY_NAME};

        return db.query(CustomerMaster.CakeCategory.TABLE_NAME,projection,null,null,null,null,null);
    }


    public Cursor Admin_Item_name_check(){
        SQLiteDatabase db=getReadableDatabase();
        String[] projection = {CustomerMaster.CakeItems.COLUMN_NAME_ID, CustomerMaster.CakeItems.COLUMN_NAME_PRODUCT_NAME,
                CustomerMaster.CakeItems.COLUMN_NAME_COUNT, CustomerMaster.CakeItems.COLUMN_NAME_DESCRIPTION, CustomerMaster.CakeItems.COLUMN_NAME_PRICE,
                CustomerMaster.CakeItems.COLUMN_NAME_PRODUCTIMAGE, CustomerMaster.CakeItems.COLUMN_NAME_FOREIGNKEY};

        return db.query(CustomerMaster.CakeItems.TABLE_NAME,projection,null,null,null,null,null);
    }
